...
More details about supported KMS implementations and configuration can be found at the [KMS guide](https://github.com/nitrictech/minio/blob/master/docs/kms/README.md).
