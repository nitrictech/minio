...
A sample msgpack-JSON `xl.meta`, you can debug the content inside `xl.meta` using [xl-meta.go](https://github.com/nitrictech/minio/tree/master/docs/debugging#decoding-metadata) program.
