...
import (
	...
	"github.com/nitrictech/minio/internal/bpool"
	"github.com/nitrictech/minio/internal/dsync"
...
func newErasureSets(ctx context.Context, endpoints PoolEndpoints, storageDisks []StorageAPI, format *formatErasureV3, defaultParityCount, poolIdx int) (*erasureSets, error) {
	...
	if defaultParityCount == 0 {
		logger.Info("Warning: Default parity set to 0. This can lead to data loss.")
	}
